...
def main() -> None:
    ...
    parser.add_argument(
        "--ts_native_functions_cpp",
        default="torch/csrc/lazy/ts_backend/ts_native_functions.cpp",
        help="Path to the torch/csrc/lazy/ts_backend/ts_native_functions.cpp",
    )
    parser.add_argument(
        "--shape_inference_hdr",
        default=None,
    ...
    if options.gen_lazy_ts_backend:
        ...
        ts_native_functions = options.ts_native_functions_cpp
        ...
        run_gen_lazy_tensor(
            ...
            build_in_tree=True,
            shape_inference_hdr=options.shape_inference_hdr,
